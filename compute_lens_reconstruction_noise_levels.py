...
t_noise = parser.get(lensing_noise, 'nlev_t')
p_noise = parser.get(lensing_noise, 'nlev_p')
beam = parser.get(lensing_noise, 'beam_fwhm')
lmin = parser.get(lensing_noise, 'lmin')
lmax = parser.get(lensing_noise, 'lmax')
...
nlpp_TT_fullsky = np.nan_to_num(nlpp_TT_fullsky)
nlpp_EE_fullsky = np.nan_to_num(nlpp_EE_fullsky)
nlpp_TE_fullsky = np.nan_to_num(nlpp_TE_fullsky)
nlpp_TB_fullsky = np.nan_to_num(nlpp_TB_fullsky)
nlpp_EB_fullsky = np.nan_to_num(nlpp_EB_fullsky)
