...
for lmin in xrange(5,32):
    ...
    for key_y in ['omnuh2']:
        ...
        ax1.set_xlabel(r'$\rm{prior}/\sigma(x)_{\rm \rm S4~ +~ Planck ~ Pol  (\ell<50) + ~BAO15}$')
        ...
        # ============================================
        plt.savefig('./prior_{}-{}.png'.format(str(key_y),lmin), dpi=200, papertype='Letter',
