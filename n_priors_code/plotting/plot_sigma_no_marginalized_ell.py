...
sigma1 = np.loadtxt('../output/no_marginalized_ell.txt')
...
plot2 = plot_type(sigma1[:,0],sigma1[:,1]/sigma1[100,1], linewidth=1,label='No Priors')
plot2 = plot_type(sigma1[:,0],sigma1[:,2]/sigma1[100,2], linewidth=1,label='No Priors')
plot2 = plot_type(sigma1[:,0],sigma1[:,3]/sigma1[100,3], linewidth=1,label='No Priors')
plot2 = plot_type(sigma1[:,0],sigma1[:,4]/sigma1[100,4], linewidth=1,label='No Priors')
plot2 = plot_type(sigma1[:,0],sigma1[:,5]/sigma1[100,5], linewidth=1,label='No Priors')
plot2 = plot_type(sigma1[:,0],sigma1[:,6]/sigma1[100,6], linewidth=1,label='No Priors')
...
# ============================================
plt.savefig('../../images/sigma_no_marginalized_ell.pdf', dpi=400, papertype='Letter',
