...
plot2 = plot_type(sigma1[:,0],sigma1[:,fid.keys().index('re_optical_depth')+1], linewidth=1,label='Degeneracies')
plot2 = plot_type(sigma_no[:,0],sigma_no[:,fid.keys().index('re_optical_depth')+1], linewidth=1,label='Perfect priors')
...
# ============================================
plt.savefig('../../images/sigma_tau_ell.pdf', dpi=400, papertype='Letter',
