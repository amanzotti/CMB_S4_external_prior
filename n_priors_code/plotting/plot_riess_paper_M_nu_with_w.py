...
for  key_y in ['omnuh2']:
    ...
    for i, key in enumerate(['hubble']):
        ...
        prior_value = np.linspace(sigma_just_CMB_x / 100., sigma_just_CMB_x * 5.5, 900)
        ...
        # plot
        line_plot = ax1.plot(prior_value*100, new_sigma * (94. * 1000.), linestyle=next(linecycler))
    ...
    ax1.set_xlabel(r'$H_{0} ~~ \rm{prior}$')
    y1, y2 = ax1.get_ylim()
    ax2 = ax1.twinx()
    ...
    # ============================================
    plt.savefig('/home/manzotti/n_eff-dependence-on-prior/Notes/images/prior_{}_riess_lmin={}_lmax={}_ndet={}_fsky={}_with_w.pdf'.format(str(key_y), lmin, lmax, N_det, fsky), dpi=400, papertype='Letter',
