...
def calc_c_fiducial(data):
    ...
    return np.array([[data[lmin_index:lmax_index, 2, 0] + fac * N * 2.]])
...
def calc_c_general(data, parabin):
    ...
    '''
    return np.array([[data[lmin_index:lmax_index, 2, parabin]]
                     ])
...
Y = 0.25  # 25% yeld
# ===================
header = 'EE fisher CMB T E + phi lensing used \n'
header += 'lmax={} \n lmin={} \n l_t_max={} \n fsky={} \n lensed={} \n data_folder={} \n N_det={} \n'.format(
...
np.savetxt('data/{}/no_marginalized_ell_EE_lmin={}_lmax={}_ndet={}_fsky={}.txt'.format(output_folder, lmin, lmax, N_det, fsky),
           np.column_stack((dats[lmin_index:lmax_index, 0, 0], no_marginalized_ell)), header=header)
np.savetxt('data/{}/marginalized_ell_EE_lmin={}_lmax={}_ndet={}_fsky={}.txt'.format(output_folder, lmin, lmax, N_det, fsky),
           np.column_stack((dats[lmin_index:lmax_index, 0, 0], marginalized_ell)), header=header)
np.save('data/{}/full_fisher_mat_EE_lmin={}_lmax={}_ndet={}_fsky={}.npy'.format(output_folder, lmin, lmax, N_det, fsky),
        fisher_save)

np.savetxt('data/{}/ell_indeces_EE_lmin={}_lmax={}_ndet={}_fsky={}.txt'.format(output_folder, lmin, lmax, N_det, fsky),
...
np.savetxt('data/{}/invetered_sqrt_fisher_EE_lmin={}_lmax={}_ndet={}_fsky={}.txt'.format(output_folder,
                                                                                            lmin, lmax, N_det, fsky), np.sqrt(fisher_inv), header=header)
np.savetxt('data/{}/fisher_mat_EE_lmin={}_lmax={}_ndet={}_fsky={}.txt'.format(output_folder,
