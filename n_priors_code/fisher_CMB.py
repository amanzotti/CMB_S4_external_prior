...
def calc_c_fiducial(data):
    ...
    return np.array([[data[lmin_index:lmax_index, 1, 0] + fac * N, data[lmin_index:lmax_index, 4, 0]],
...
Y = 0.25  # 25% yeld
# ===================
header = 'CMB fisher CMB T E + phi lensing used \n'
header += 'lmax={} \n lmin={} \n l_t_max={} \n fsky={} \n lensed={} \n data_folder={} \n N_det={} \n'.format(
...
np.savetxt('data/{}/no_marginalized_ell_CMB_lmin={}_lmax={}_ndet={}_fsky={}.txt'.format(output_folder, lmin, lmax, N_det, fsky),
