...
\caption{Some as \reffig{prior_omeganuh2} but with $\pmb{\ell_{\rm min}>50}$ as a function of priors on cosmological parameters, as in \reffig{prior_massless_neutrinos}. }
...
Notice that external prior effect are not completely independent. An external prior on $H_{0}$ for example, improve the internal reconstruction of $\Omega_ch^2$ as well.
...
Together with the importance of $H_{0}$ and $\Omega_ch^2$ that we also observed in \reffig{prior_omeganuh2}, in this case external priors on $A_{s}$ and $\tau$ will be helpful.
Indeed as recently pointed out by \cite{allison:2015}, a degeneracy exists between $\sum m_\nu$ and $\tau$. A measurement of the optical depth will help to constraint the primordial amplitude $A_{s}$ which is degenerate with the mass of neutrinos. Indeed, increasing the mass of neutrinos will decrease the CMB lensing power spectrum and this can be compensating by increasing $A_{s}$.
