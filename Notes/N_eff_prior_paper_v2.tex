...
The position of the CMB peaks, well constrained by measurement, is a function $\Omega_ch^3$\sd{get the right power from the Planck paper and cite that} and for this reason too an external prior on $H_{0}$ will improve the internal reconstruction of $\Omega_ch^2$.
