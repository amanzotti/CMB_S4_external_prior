...
\caption{Constraints on the sum of the neutrino masses (absolute on the left and and relative to its value on the right) as a function of priors on the Hubble parameter $A_{s}$. The horizontal (blue) line correspond to CMB S4 experiment + Planck Pol + DESI.}
...
\caption{Constraints on the sum of the neutrino masses (absolute on the left and and relative to its value on the right) as a function of priors on the Hubble parameter $\Omega_{c} h^{2}$. The horizontal (blue) line correspond to CMB S4 experiment + Planck Pol + DESI.}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics{{prior_omnuh2_scalar_spectral_index(1)_lmin=50_lmax=4499_ndet=1000000_fsky=0.75}.pdf}
\caption{Constraints on the sum of the neutrino masses (absolute on the left and and relative to its value on the right) as a function of priors on the Hubble parameter $n_{s}$. The horizontal (blue) line correspond to CMB S4 experiment + Planck Pol + DESI.}
\label{fig:prior_omeganuh2-50-ns}
\end{center}
\end{figure}
%==========
