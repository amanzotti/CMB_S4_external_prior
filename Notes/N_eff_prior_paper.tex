...
%In this work we will mainly focus on two of these: neutrinos and Dark Energy.
...
%their ratio $r_{d}/r_{s}\propto\sqrt{H}$ 
...
This technique however introduces also some technical difficulties and assumptions. 
