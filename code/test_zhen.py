...
fid = pickle.load(open('data/{}/run5/fid_values.p'.format('test_fisher'), "rb"))
values = pickle.load(open('data/{}/run5/grid_values.p'.format('test_fisher'), "rb"))
par_gaps = pickle.load(open('data/{}/run5/par_gaps.p'.format('test_fisher'), "rb"))
index = {}
...
my_fisher_inv_1 = np.genfromtxt('output/invetered_fisher_test_run1.txt')
my_fisher_inv_2 = np.genfromtxt('output/invetered_fisher_test_run2.txt')
my_fisher_inv_3 = np.genfromtxt('output/invetered_fisher_test_run3.txt')
my_fisher_inv_4 = np.genfromtxt('output/invetered_fisher_test_run4.txt')
my_fisher_inv_5 = np.genfromtxt('output/invetered_fisher_test_run5.txt')
