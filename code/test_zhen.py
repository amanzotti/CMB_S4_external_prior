...
fid = pickle.load(open('data/{}/run8/fid_values.p'.format('test_fisher'), "rb"))
values = pickle.load(open('data/{}/run8/grid_values.p'.format('test_fisher'), "rb"))
par_gaps = pickle.load(open('data/{}/run8/par_gaps.p'.format('test_fisher'), "rb"))
index = {}
...
my_fisher_1 = np.genfromtxt('output/fisher_mat_test_run7.txt')
my_fisher_2 = np.genfromtxt('output/fisher_mat_test_run8.txt')
