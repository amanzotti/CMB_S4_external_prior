...
def C(iell, ell, parbin, data):
    ...
    # TE,EE,Ephi
    # phiT,phiE,phiphi
    C = np.array([data[iell, 2, parbin] / fac + N * 2.])
...
np.savetxt('output_EE/sigma_H0_1percent.txt', d2)
np.savetxt('output_EE/sigma_H0_noPrior.txt', d)
np.savetxt('output_EE/sigma_H0_perfect_prior.txt', d3)
...
np.savetxt('output_EE/sigma_tau_1percent.txt', d2)
np.savetxt('output_EE/sigma_tau_noPrior.txt', d)
np.savetxt('output_EE/sigma_tau_perfect_prior.txt', d3)
...
np.savetxt('output_EE/sigma_ns_1percent.txt', d2)
np.savetxt('output_EE/sigma_ns_noPrior.txt', d)
np.savetxt('output_EE/sigma_ns_perfect_prior.txt', d3)
