...
plot2 = plot_type(sigma1[:,0],sigma1[:,fid.keys().index('massless_neutrinos')+1], linewidth=1,label='Degeneracies')
...
# ============================================
plt.savefig('../../images/sigma_N_eff_ell.pdf', dpi=400, papertype='Letter',
