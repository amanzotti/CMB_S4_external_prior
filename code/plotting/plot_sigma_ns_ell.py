...
plot2 = plot_type(sigma1[4:,0],sigma1[4:,fid.keys().index('scalar_spectral_index(1)')+1], linewidth=1,label='Degeneracies')
plot2 = plot_type(sigma_no[4:,0],sigma_no[4:,fid.keys().index('scalar_spectral_index(1)')+1], linewidth=1,label='Perfect priors')
...
# ============================================
plt.savefig('../../images/sigma_ns_ell.pdf', dpi=400, papertype='Letter',
