...
plot2 = plot_type(sigma1[10:,0],sigma1[10:,fid.keys().index('massless_neutrinos')+1], linewidth=1,label='Joint')
# plot2 = plot_type(sigma_no[:,0],sigma_no[:,fid.keys().index('massless_neutrinos')+1], linewidth=1,label='Perfect priors')
plot2 = plot_type(sigma1ee[10:,0],sigma1ee[10:,fid.keys().index('massless_neutrinos')+1], linewidth=1,label='EE')
# plot2 = plot_type(sigma_no[:,0],sigma_no[:,fid.keys().index('massless_neutrinos')+1], linewidth=1,label='Perfect priors')
plot2 = plot_type(sigma1te[10:,0],sigma1te[10:,fid.keys().index('massless_neutrinos')+1], linewidth=1,label='TE')
# plot2 = plot_type(sigma_no[:,0],sigma_no[:,fid.keys().index('massless_neutrinos')+1], linewidth=1,label='Perfect priors')
plot2 = plot_type(sigma1tt[10:,0],sigma1tt[10:,fid.keys().index('massless_neutrinos')+1], linewidth=1,label='TT')
# plot2 = plot_type(sigma_no[:,0],sigma_no[:,fid.keys().index('massless_neutrinos')+1], linewidth=1,label='Perfect priors')
