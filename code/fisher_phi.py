...
np.savetxt('output_phi/no_marginalized_ell.txt',np.column_stack((np.arange(lmin, lmax),no_marginalized_ell)))
np.savetxt('output_phi/marginalized_ell.txt',np.column_stack((np.arange(lmin, lmax),marginalized_ell)))
...
np.savetxt('output_phi/sigma_H0_perfect_prior.txt', d3)
...
np.savetxt('output_phi/sigma_ns_1percent.txt', d2)
np.savetxt('output_phi/sigma_ns_noPrior.txt', d)
np.savetxt('output_phi/sigma_ns_perfect_prior.txt', d3)
...
# print param_cov
np.savetxt('output_phi/param_cov.txt', param_cov)
np.savetxt('output_phi/invetered_sqrt_fisher.txt', np.sqrt(fisher_inv))
