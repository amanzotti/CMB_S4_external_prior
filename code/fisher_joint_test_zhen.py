...
def C(iell, ell, parbin, data):
    ...
    '''
    npt.assert_almost_equal(data[iell, 0, 0], ell)
...
# For safety kill everything above 3000 which is what Zhen used
dats[3010:, : , :] = 0.
